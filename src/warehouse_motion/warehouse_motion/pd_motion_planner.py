...
class PDMotionPlanner(Node):
    ...
    def control_loop(self):
        ...
        self.get_logger().warn(f"frame_id Robot Pose: {robot_pose_transform.header.frame_id}")
        self.get_logger().warn(f"frame_id Gloabal Plan: {self.global_plan.header.frame_id}")
