...
#include "warehouse_planning/dijkstra_planner.hpp"

namespace warehouse_planning
{
...
PLUGINLIB_EXPORT_CLASS(warehouse_planning::DijkstraPlanner, nav2_core::GlobalPlanner)